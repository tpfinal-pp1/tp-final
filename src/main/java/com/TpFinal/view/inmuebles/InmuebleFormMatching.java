...
public class InmuebleFormMatching extends FormLayout {
    private InmuebleService inmbService = new InmuebleService();
    private PersonaService personaService = new PersonaService();
    private Inmueble inmueble;
    final static Logger logger = Logger.getLogger(InmuebleFormMatching.class);
    ...
    public InmuebleFormMatching(InmuebleMatchingView inmuebleMatchingView) {
	this.abmView = inmuebleMatchingView;
	configureComponents();
	binding();
	buildLayout();
	updateComboPersonas();
	...
	if (getABMView().isIsonMobile())
	    this.focus();	
	deshabilitarEdicionDeComponentes();
    }

    private void deshabilitarEdicionDeComponentes() {
	binderInmueble.getFields().forEach(f -> f.setReadOnly(true));
	this.btnNuevoPropietario.setVisible(false);
	this.buscarUbicacion.setVisible(false);
	this.delete.setVisible(false);
	this.imageManager.setVisible(false);
    ...
    public InmuebleMatchingView getABMView() {
	return abmView;
    }
