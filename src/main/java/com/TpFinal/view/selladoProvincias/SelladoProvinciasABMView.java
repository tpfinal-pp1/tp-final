...
@Title("Addressbook")
@Theme("valo")
public class SelladoProvinciasABMView extends DefaultLayout implements View {
    ...
    private FiltroSellado filtro;

    public SelladoProvinciasABMView() {
